...
ATM client1 = new ATM("12345");
    ...
    private void initComponents() {
        ...
        setTitle("PLEASE ENTER YOUR CARD NUMBER");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField1.getText() == null ? client1.getCardNumber() == null : jTextField1.getText().equals(client1.getCardNumber()))
            new GUI().setVisible(true); 
        else
          JOptionPane.showMessageDialog(null, "Invalid card number!", "", JOptionPane.INFORMATION_MESSAGE);
